...
✞ Open this link 👉 https://anthony-boniphace.onrender.com/pair then tap on pair code.
✞ Enter your whatsapp number with the country code e.g;  255716661569 then tap submit 
✞Boniphace Md owner , *Boniphace and Yesser Tech* ,will send you the code immediately.Copy the code and whatsapp will bring a notification 
...
✔ Now check on Boniphace repository in github fork and give a star to this repository before doing anything 🌟or else Boniphace Md owner won't allow you to deploy his bot💀.
...
let menuMsg = `
   ...
   if (lien.match(/\.(mp4|gif)$/i)) {
    try {
        zk.sendMessage(dest, { video: { url: lien }, caption:infoMsg + menuMsg, footer: "Je suis *boniphace*, déveloper boniphace Tech" , gifPlayback : true }, { quoted: ms });
    }
    catch (e) {
...
// Vérification pour .jpeg ou .png
    ...
    try {
        zk.sendMessage(dest, { image: { url: lien }, caption:infoMsg + menuMsg, footer: "Je suis *boniphace*, déveloper boniphace Tech" }, { quoted: ms });
    }
    catch (e) {
        console.log("🥵🥵 Menu erreur " + e);
        repondre("🥵🥵 Menu erreur " + e);
